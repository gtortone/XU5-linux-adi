...
/* ADF4371_REG32 */
#define ADF4371_ADC_CONVERSION		BIT(3)
#define ADF4371_ADC_ENABLE		BIT(2)
...
/* ADF4371_REG73 */
#define ADF4371_ADC_CLK_DISABLE		BIT(2)
			...
			long info)
{
	...
	case IIO_CHAN_INFO_PROCESSED:
		...
		ret = regmap_update_bits(st->regmap, ADF4371_REG(0x33),
					ADF4371_VCO_FSM_READBACK_MSK, 5);
		if (ret < 0)
			break;
